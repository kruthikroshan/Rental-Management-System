...
const productSchema = z.object({
  ...
  pricePerHour: z.number().min(0, 'Price cannot be negative').optional().nullable(),
  pricePerDay: z.number().min(0.01, 'Price must be greater than 0'),
  pricePerWeek: z.number().min(0, 'Price cannot be negative').optional().nullable(),
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setValue('condition', product.condition || 'Good');
        setValue('pricePerHour', product.pricePerHour || '');
        setValue('pricePerDay', product.pricePerDay);
        setValue('pricePerWeek', product.pricePerWeek || '');
        setValue('stock', product.stock);
        setValue('isRentable', product.isRentable);
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                step="0.01"
                min="0"
                {...register('pricePerHour', { valueAsNumber: true, setValueAs: v => v === "" ? null : Number(v) })}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                placeholder="0.00"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                step="0.01"
                min="0"
                {...register('pricePerWeek', { valueAsNumber: true, setValueAs: v => v === "" ? null : Number(v) })}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                placeholder="0.00"
              />
            </div>
