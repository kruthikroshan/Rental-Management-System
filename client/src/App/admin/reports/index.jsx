...
const Reports = () => {
  ...
  const handleExportCSV = async (type) => {
    try {
      const response = await api.get(`/reports/export/csv?type=${type}`, { responseType: 'blob' });
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      {dashboardStats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl shadow-xl border border-amber-200 p-8 text-white transform hover:scale-105 transition-all duration-200">
            <div className="flex items-center justify-between mb-6">
              <div>
                <p className="text-amber-100 text-sm font-medium mb-2">Platform Satisfaction</p>
                <p className="text-3xl font-bold">{dashboardStats.averagePlatformRating?.toFixed(1) || '0.0'}/5</p>
              </div>
              <div className="bg-amber-400 bg-opacity-30 rounded-xl p-4">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-amber-100 text-sm">Avg product rating</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 px-8 py-6 border-b border-gray-200 flex justify-between items-center">
            <div>
            ...
            <button
              ...
              className="bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition shadow-sm"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
              Export CSV
            </button>
        ...
        {/* Top Customers Table */}
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-green-50 to-green-100 px-8 py-6 border-b border-gray-200 flex justify-between items-center">
            <div>
