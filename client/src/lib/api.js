...
export const authAPI = {
  ...
  googleLogin: (body) => api.post('/auth/google/verify', body).then(r => r.data),
  verifyEmail: (body) => api.post('/auth/verify-email', body).then(r => r.data),
  resendOTP: (body) => api.post('/auth/resend-otp', body).then(r => r.data),
  requestPhoneOTP: (body) => api.post('/auth/request-phone-otp', body).then(r => r.data),
  verifyPhoneOTP: (body) => api.post('/auth/verify-phone-otp', body).then(r => r.data),
...
export const reviewsAPI = {
  ...
  addReview: (body) => api.post('/reviews/add', body).then(r => r.data),
  getAllReviews: () => api.get('/reviews/all').then(r => r.data),
  deleteReview: (reviewId) => api.delete(`/reviews/delete/${reviewId}`).then(r => r.data),
};
