...
<table align="center">
<tr>
<td align="center"><strong> Kruthik Roshan</strong><br><em>Full Stack Developer</em></td>
</tr>
</table>
...
✅ **Session 19 - Google OAuth Login System**
- Implemented Google OAuth 2.0 authentication flow
- Secure token verification and user management
- Integration with existing user schema
- OAuth routes: `/auth/google`, `/auth/google/callback`, `/auth/google/verify`

✅ **Session 17 - Bug Fixes**
- Fixed wishlist clearing after checkout
- Resolved "Access Denied" error for customers after login
- Enhanced role-based access control with better defaults
- Added `/rentals` route alias for better navigation
...
**Built with ❤️ by Kruthik Roshan**

*Transforming the rental industry, one line of code at a time*

---

[![GitHub stars](https://img.shields.io/github/stars/kruthikroshan/Rental-Management-System?style=social)](https://github.com/kruthikroshan/Rental-Management-System/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/kruthikroshan/Rental-Management-System?style=social)](https://github.com/kruthikroshan/Rental-Management-System/network/members)
[![GitHub issues](https://img.shields.io/github/issues/kruthikroshan/Rental-Management-System)](https://github.com/kruthikroshan/Rental-Management-System/issues)
